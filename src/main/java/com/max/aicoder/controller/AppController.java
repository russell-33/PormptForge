package com.max.aicoder.controller;

import cn.hutool.core.bean.BeanUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONUtil;
import com.max.aicoder.annotation.AuthCheck;
import com.max.aicoder.common.BaseResponse;
import com.max.aicoder.common.DeleteRequest;
import com.max.aicoder.common.ResultUtils;
...
import com.max.aicoder.model.dto.app.*;
import com.max.aicoder.model.entity.App;
import com.max.aicoder.model.entity.User;
import com.max.aicoder.model.vo.AppVO;
import com.max.aicoder.ratelimiter.annotation.RateLimit;
import com.max.aicoder.ratelimiter.enums.RateLimitType;
import com.max.aicoder.service.AppService;
import com.max.aicoder.service.ProjectDownloadService;
...
public class AppController {
     ...
     * @return
     */
    @RateLimit(limitType = RateLimitType.USER, rate = 5, rateInterval = 60, message = "AI对话过于频繁")
    ...
    public Flux<ServerSentEvent<String>> chatToGenCode(@RequestParam Long appId,
        ...
        return Flux.defer(() -> {
                    ...
                    return contentFlux.map(this::buildDataEvent);
                })
    ...
    private ServerSentEvent<String> buildErrorEvent(Throwable error) {
        ...
        String errorMessage = ErrorCode.SYSTEM_ERROR.getMessage();
    ...
    public void downloadAppCode(@PathVariable Long appId,
        ...
        // 6. 生成下载文件名（不建议添加中文内容）
        String downloadFileName = String.valueOf(app.getAppName());
        // 7. 调用通用下载服务
    ...
    public BaseResponse<Long> addApp(@RequestBody AppAddRequest appAddRequest, HttpServletRequest request) {
        throwIf(appAddRequest == null, ErrorCode.PARAMS_ERROR);
        User loginUser = userService.getLoginUser(request);
    ...
    public BaseResponse<Boolean> deleteApp(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        throwIf(oldApp == null, ErrorCode.NOT_FOUND_ERROR);
        // 仅本人或管理员可删除
        ...
        if (StrUtil.isNotBlank(coverUrl)) {
            screenShotService.deleteScreenshot(coverUrl);
        }
    ...
    public BaseResponse<AppVO> getAppVOById(long id) {
        ...
        throwIf(app == null, ErrorCode.NOT_FOUND_ERROR);
        // 获取封装类（包含用户信息）
    ...
    public BaseResponse<Page<AppVO>> listMyAppVOByPage(@RequestBody AppQueryRequest appQueryRequest, HttpServletRequest request) {
        throwIf(appQueryRequest == null, ErrorCode.PARAMS_ERROR);
        User loginUser = userService.getLoginUser(request);
        // 限制每页最多 20 个
        long pageSize = appQueryRequest.getPageSize();
        throwIf(pageSize > 20, ErrorCode.PARAMS_ERROR, "每页最多查询 20 个应用");
    ...
    @Cacheable(
            value = "good_app_page",
            key = "T(com.max.aicoder.utils.CacheKeyUtils).generateKey(#appQueryRequest)",
