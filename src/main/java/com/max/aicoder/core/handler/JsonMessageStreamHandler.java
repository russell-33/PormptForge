package com.max.aicoder.core.handler;

import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.max.aicoder.ai.model.message.*;
        ...
        switch (typeEnum) {
            ...
            case TOOL_REQUEST -> {
                ...
                if (toolId != null && !seenToolIds.contains(toolId)) {
                    ...
                    return toolManager
                            .getTool(toolRequestMessage.getName())
            ...
            case TOOL_EXECUTED -> {
                ...
                String result = toolManager
                        .getTool(toolExecutedMessage.getName())
                        .generateToolExecutedResult(jsonObject);
                // 输出前端和要持久化的内容
