...
import com.max.aicoder.ai.AiCodeGeneratorService;
import com.max.aicoder.ai.AiCodeGeneratorServiceFactory;
import com.max.aicoder.ai.model.HtmlCodeResult;
import com.max.aicoder.ai.model.MultiFileCodeResult;
import com.max.aicoder.ai.model.message.AiResponseMessage;
import com.max.aicoder.ai.model.message.ToolExecutedMessage;
import com.max.aicoder.ai.model.message.ToolRequestMessage;
import com.max.aicoder.constant.AppConstant;
import com.max.aicoder.core.builder.VueProjectBuilder;
import com.max.aicoder.core.parser.CodeParserExecutor;
import com.max.aicoder.core.saver.CodeFileSaverExecutor;
...
public class AiCodeGeneratorFacade {
    ...
    public File generateAndSaveCode(String userMessage, CodeGenTypeEnum codeGenTypeEnum, Long appId) {
        throwIf(userMessage == null, ErrorCode.PARAMS_ERROR, "用户提示词为空");
        ...
        return Flux.create(sink -> {
            tokenStream.onPartialResponse((String partialResponse) -> {
                    ...
                    .onCompleteResponse((ChatResponse response) -> {
                        // 添加完消息后，同步构建vue项目
                        String projectDirName = AppConstant.CODE_OUTPUT_ROOT_DIR + "/vue_project_" + appId;
        ...
        return codeStream
                ...
                .doOnComplete(() -> {
                    ...
                    try {
                        ...
                        // 保存代码到文件
                        File savedDir = CodeFileSaverExecutor.executeSaver(parserResult, codeGenTypeEnum, appId);
